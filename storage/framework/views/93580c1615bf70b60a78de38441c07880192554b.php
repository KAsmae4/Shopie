                ...
                <form action="<?php echo e(route('admin.products.update', $product->id)); ?>" method="post">
                    ...
                    <select class="form-control" name="category_id" id="">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $categoryName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e($id === $product->category->id ? 'selected' : null); ?> value="<?php echo e($id); ?>"><?php echo e($categoryName); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="tags[]" multiple id="tags">
                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $tagName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e(in_array($id, $product->tags->pluck('id')->toArray()) ? 'selected' : null); ?> value="<?php echo e($id); ?>"><?php echo e($tagName); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>   
                    </div>
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" name="name" value="<?php echo e(old('name', $product->name)); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quantity" value="<?php echo e(old('quantity', $product->quantity)); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="weight">weight</label>
                        <input type="number" name="weight" value="<?php echo e(old('weight', $product->weight)); ?>" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="details" id="details" cols="30" rows="5"><?php echo e($product->details); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\eco\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>