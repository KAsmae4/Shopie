<?php $__env->startSection('content'); ?>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="<?php echo e(asset('frontend/img/banner.png')); ?>">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <div class="breadcrumb__text">
              ...
              <div class="breadcrumb__option">
                ...
                <span>Détails des Produits</span>
              </div>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\eco\resources\views/frontend/product/show.blade.php ENDPATH**/ ?>